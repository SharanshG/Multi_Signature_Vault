...
contract MultiSig {
  ...
  function submitTransaction(address _to, uint _value, bytes _data) external onlyOwner {
  ...
  function executeTransaction(uint _txIndex)
        ...
        notExecuted(_txIndex)
    {
        ...
        //bool success = transaction.to.call{value: transaction.value; data: transaction.data};
        //(bool success, ) = transaction.to.call{value: transaction.value}; data: transaction.data};
